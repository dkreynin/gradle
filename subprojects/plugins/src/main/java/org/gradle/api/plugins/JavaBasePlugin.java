...
public class JavaBasePlugin implements Plugin<Project> {
    ...
    private DefaultJavaPluginExtension addExtensions(final ProjectInternal project) {
        ...
        ((ExtensibleDynamicObject) ((DynamicObjectAware) project).getAsDynamicObject()).getConvention().getPlugins().put("java", new DefaultJavaPluginConvention(project, javaPluginExtension));
