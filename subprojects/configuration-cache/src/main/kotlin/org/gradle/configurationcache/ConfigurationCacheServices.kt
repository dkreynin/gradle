...
class ConfigurationCacheServices : AbstractPluginServiceRegistry() {
    ...
    class BuildScopeServicesProvider {
        ...
        fun createCrossProjectModelAccess(projectRegistry: ProjectRegistry<ProjectInternal>,
                                          modelParameters: BuildModelParameters,
                                          problemsListener: ProblemsListener,
                                          userCodeApplicationContext: UserCodeApplicationContext): CrossProjectModelAccess {
